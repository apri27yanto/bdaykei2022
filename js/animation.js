...
const config = {
    name: "keisha", // actual name of the recipient (Mandatory)

    nickname: "Keisha Risfalah Fathin", // nickname(optional)
...
CTAtext.innerHTML = "Tekan untuk menyalakan lampu.";
...
button.addEventListener("click",function(){
    ...
    if(button.classList.contains("switch")) {
        ...
        */
        ...
        door.play();
        transition(hallway);
        CTAtext.innerHTML = "Tekan hadiahnya";
        setTimeout(function() {
        ...
        */
        ...
        document.querySelector(".HBD").textContent = "Selamat Ulang Tahun";
